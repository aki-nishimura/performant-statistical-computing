...
* Observational study with multiple exposure-outcomes
</p>
...
.pull-left[
  ![:image right, 80%](figure/reference/medium_logo.png)
  ![:vspace -1ex]
]

![:image right, 70%](figure/reference/stack_overflow_logo.png)
![:vspace -.5ex]

![:image left, 45%](figure/reference/google_logo.png)
![:vspace 3ex]

![:image right, 60%](figure/reference/geeksforgeeks_logo.png)
